...
import { riconosci, vocabolarioPer, vociDaParole, racconta as raccontaOcchio, abbina, sovrapposizione } from "./veritas_riconosce.js?v=13";
...
export function promptAssegnazione(studio, volumi, testimonianza, giaFatto) {
  return [
    ...
    "  nella sequenza e QUELLO CHE SI VEDE SOPRA O DENTRO il volume. Le sedute in",
    "  fila fanno una sala d'attesa, i banchi rivolti da una parte un'aula, i letti",
    "  affiancati un reparto, gli scaffali paralleli una vendita: dirlo e' una",
    "  deduzione architettonica normale, non un'invenzione. Usa gli scorci per",
    "  l'altezza e quello che c'e' attorno all'edificio per orientarti.",
    "- ⚠️ Questo edificio puo' essere qualunque cosa: un aeroporto, una scuola, un",
    "  museo, un ospedale, un negozio, una palestra. Non dare per scontata una",
    "  tipologia e non forzare i volumi dentro quella che hai in mente: leggi gli",
    "  oggetti che ci sono e lascia che siano loro a dire di che edificio si tratta.",
