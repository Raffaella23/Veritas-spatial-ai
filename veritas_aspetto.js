...
/* La console, riportata dentro il dock. Le regole originali la mettevano a
   ...
   top e bottom insieme la tenevano alta quanto lo schermo SEMPRE, anche con
   due righe di log dentro: da qui il pannello enorme e quasi vuoto. Adesso e'
   ancorata solo in basso e cresce con quello che ha dentro; il calc e' un
   tetto, non una posizione. */
#vaio-console{
...
/* flex:1 gonfiava il log fino a riempire il pannello: era l'altra meta' del
   riquadro vuoto. Con 0 1 auto il log e' alto quanto le righe che ha, e si
   restringe (min-height:0) scorrendo dentro se stesso quando si arriva al
   tetto del pannello. */
#vaio-console-log{flex:0 1 auto!important;min-height:0!important;max-height:none!important;font-size:11.5px!important;}
