...
const VISIBILI = {
  ...
  // Il pannello Punti (i nodi/tappe) entra qui e non in ingresso: senza
  // modello non c'e' niente su cui posizionare un punto.
  modello: ["vaio-brand", "vaio-toolbar", "va-rail", "veritas-picker-panel"],
  analisi: ["vaio-brand", "vaio-toolbar", "va-rail", "veritas-picker-panel"],
};
...
function applicaFase() {
  ...
  //
  // veritas-picker-panel (il pannello Punti) ci entra: prima la sua visibilita'
  // dipendeva solo da cadVisible (l'interruttore "Editor zone" dentro la
  // toolbar), un sistema indipendente dalla fase. Tornando in ingresso -
  // per esempio caricando un altro progetto - la toolbar spariva ma il
  // pannello, se era rimasto aperto, restava a schermo senza piu' un
  // interruttore raggiungibile per chiuderlo. va-fuori-fase si somma a
  // vaio-hidden, non lo sostituisce: fuori da modello/analisi il pannello
  // sparisce comunque, dentro resta cadVisible a decidere.
  const tutti = ["vaio-brand", "vaio-toolbar", "vaio-upload-wrap", "va-rail", "veritas-picker-panel"];
