...
> ## 🔴 STOP — READ `../ui-ux-pro-max/PROJECT_CONSTRAINTS.md` FIRST
>
> This skill is vendored into the **VERITAS Spatial AI** repository and is **overridden** by
> `../ui-ux-pro-max/PROJECT_CONSTRAINTS.md`. Read it before applying anything below.
>
> Scope here is deliberately narrow — this skill was brought in **only** for its token architecture:
>
> - ✅ **Use**: `references/token-architecture.md`, `primitive-tokens.md`, `semantic-tokens.md`,
>   `component-tokens.md`, `states-and-variants.md`, `templates/design-tokens-starter.json`,
>   `scripts/html-token-validator.py`
> - ❌ **Ignore all slide generation**: `data/slide-*.csv`, `generate-slide.py`, `search-slides.py`,
>   `slide_search_core.py`, `slide-token-validator.py`. VERITAS is not a presentation.
> - ❌ **Ignore `references/tailwind-integration.md`** — Tailwind is forbidden in this project.
>
> Emit tokens as **CSS custom properties inline in the single HTML file** — never as a Tailwind config,
> never as an external JSON file.
