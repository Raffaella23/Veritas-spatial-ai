...
import { comprendi, puoAgire, racconta } from "./veritas_comprensione.js?v=8"   // ⚠️ la versione serve: senza, il browser tiene la copia vecchia;
...
import { anteprima } from "./veritas_anteprima.js?v=14";
import { occhioLocale, piantaInTela, stato } from "./veritas_riconosce.js?v=3";
