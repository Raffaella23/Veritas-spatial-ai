...
import { abaco } from "./veritas_tavole.js?v=6";
...
import { comprendi, puoAgire, racconta,
         VISTE_PER_GIRO, GIRI_MASSIMI } from "./veritas_comprensione.js?v=19"   // ⚠️ la versione serve: senza, il browser tiene la copia vecchia;
