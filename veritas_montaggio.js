...
import { comprendi, puoAgire, racconta } from "./veritas_comprensione.js?v=5"   // ⚠️ la versione serve: senza, il browser tiene la copia vecchia;
...
import { anteprima } from "./veritas_anteprima.js?v=10";
